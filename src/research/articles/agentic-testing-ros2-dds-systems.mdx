...
<FlowDiagram title="One test sequence, five stages" steps={["Discover the graph", "Prove readiness", "Command and verify", "Record evidence", "Report verdict"]} />
...
<StatFigure title="Discovery pass on a live domain" stats={[["Topics visible", "332"], ["Bridge topics", "/nexus/* pub=1"], ["Transport", "dds_udp"], ["Session readiness", "ready"]]} />
...
<StatFigure title="Requirement-verdict gate, 15 runs" stats={[["Runs", "15 / 15 PASS"], ["Gate evaluations", "30 / 30 matched"], ["Match latency", "0.26 – 0.37 s"], ["Flakes", "0"]]} />

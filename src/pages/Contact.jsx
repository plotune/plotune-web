...
const ContactPage = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-dark-bg py-20 text-dark-text md:py-28">
      ...
      <div className="relative container mx-auto max-w-4xl px-5">
        <div className="text-center">
          <p className="text-sm font-semibold uppercase tracking-[0.28em] text-primary">Contact</p>
          <h1 className="mt-5 text-4xl font-semibold text-light-text md:text-5xl">
            Tell us about your test environment.
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-text">
            Send us a message and we'll walk you through how Plotune Nexus fits your bench, your
            team, and the tools you already run -- integration details, timeline, and next steps
            included.
          </p>
